...
<title>河南锐利特物联网云灌溉系统--重置密码</title>
		...
		<div class="maincontent">
			<div class="passwordErrContent">
				...
				<div class="rights">
					...
					<br/>
					登录名：<input type="text" class="userName" style="width:190px;border:#000 solid 0px;font-size:22px;" readonly="readonly" value="${sessionScope.userName}"/>
					<br/>
					<input type="text" class="userName" style="width:50px;border:#000 solid 0px;font-size:22px;" readonly="readonly"/>新密码：<input type="password" class="password"/>
					<br/>
