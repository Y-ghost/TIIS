	...
	$(document).ready(function(){
		...
		$("#nextBtn").click(function(){
			...
			if($(".loginName").css("border")=="1px solid rgb(179, 93, 93)"){
				...
				$.ajax({
					type : "post",
					url : "http://localhost:8080/TIIS/user/i_forget_password.json",
					dataType : "json",
					...
					success : function(data){
						...
						if(data=="userNameIsNull"){
							...
							window.location.href="http://localhost:8080/TIIS/indexs/forgotPassword?email="+d[1];
						}else{
		...
		<div class="maincontent">
			<div class="passwordErrContent">
				...
				<div class="rights">
					...
					<br/>
					验证码：<input type="text" class="validCode" style="width:60px;"/>
					<input type="text" class="validArea" style="width:60px;font-size:18px;color:red;border:#000 solid 0px;height:35px;letter-spacing:3px;line-height:35px; background: #c3c3c3" readonly="readonly" value=""/>
					<input type="text"  style="width:83px;border:#000 solid 0px;" readonly="readonly"/>
					<br/>
					<br/>
					<br/>
